...
will add more specific sites soon

## Current Land Use planning in the area

![](images/clipboard-905322990.png)

We also mapped out the current Landuse in Lim Chu Kangto identify the areas which can be used for a potential Solar Farm, and which areas have to be avoided (e.g Reserve Sites, Military Use).
